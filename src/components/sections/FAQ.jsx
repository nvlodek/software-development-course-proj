        ...
        >
            ...
            <div className='outer-border'>
                    ...
                    <div className="expandable__content-wrapper">
                        <div className="expandable__content">
                            <p className="faqp">
                                ...
                                introduce Process Feedback, as well as your teaching context and grade level.
                            </p>
                            <p className="faqp">
                ...
                <div className='expandable'>
                    ...
                    <div className="expandable__content-wrapper">
                        <div className="expandable__content">
                            <p className="faqp">Yes. We have developed an extension specifically for LMSs.</p>
                            <p className="faqp">
